...
def menu_pause():
    ...
    if Pause:
        ...
        affiche_message("PAUSE", police, (dimensions_fenetre[0]/2, dimensions_fenetre[1]/2 - 4*hauteur/4 + 260), BLANC)
        ...
        affiche_message("Continuer", police, (dimensions_fenetre[0]/2, dimensions_fenetre[1]/2 - 3*hauteur/4 + 260), couleurs[0])
        affiche_message("Recommencer", police, (dimensions_fenetre[0]/2, dimensions_fenetre[1]/2 - 2*hauteur/4 + 260), couleurs[1])
        affiche_message("Quitter", police, (dimensions_fenetre[0]/2, dimensions_fenetre[1]/2 - 1*hauteur/4 + 260), couleurs[2])
    elif Pause_delai > 0:
        Pause_delai -= 1
...
def affiche_menu():
    ...
    if Option:
        ...
        if select[1] == 12:
            ...
            dessiner_fleche((180 + select[0]*FENETRE_LARGEUR//3,  6*FENETRE_HAUTEUR//20 + select[1]*(1*FENETRE_HAUTEUR//20)),NOIR, 80, 16, 16, 2)
            dessiner_fleche((180 + select[0]*FENETRE_LARGEUR//3,   6*FENETRE_HAUTEUR//20 + select[1]*(1*FENETRE_HAUTEUR//20)),VERT, 80, 16, 16)

        police  = pygame.font.Font("police/crochet.otf", 70)
        ...
        dessiner_fleche((5*FENETRE_LARGEUR//20, 11*FENETRE_HAUTEUR//20 + select[1]*(3*FENETRE_HAUTEUR//20)),NOIR, 80, 16, 16, 2)
        dessiner_fleche((5*FENETRE_LARGEUR//20, 11*FENETRE_HAUTEUR//20 + select[1]*(3*FENETRE_HAUTEUR//20)),VERT, 80, 16, 16)

        police  = pygame.font.Font("police/crochet.otf", 46)
...
def reinitialiser(new=False):
    ...
    if new:
        ...
        if(manche >= MANCHE_MIN and abs(avions[0]['score'] - avions[1]['score']) > 0):
            Jeu = False
            manche = 0
            police  = pygame.font.Font("police/crochet.otf", 80)
...
dimensions_nuage = (dimensions_nuage[0], dimensions_nuage[1])
